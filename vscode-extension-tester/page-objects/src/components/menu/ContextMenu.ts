...
export class ContextMenu extends Menu {
     ...
     */
    override async getItem(name: string): Promise<ContextMenuItem | undefined> {
        try {
     ...
     */
    override async wait(timeout: number = 5000): Promise<this> {
...
export class ContextMenuItem extends MenuItem {
    ...
    override async select(): Promise<Menu | undefined> {
        await this.click();
