...
import { removeDirectoryRecursively } from "../../src/utils/fsUtils";
...
describe("NugetHttpService", () => {
    ...
    it("getPackageReleasedVersions", async () => {
        const packageName: string = "Newtonsoft.Json";
    ...
    it("getLatestVersion", async () => {
        ...
        expect(nugetVersions[currentLength - 1].major).gt(nugetVersions[0].major);
    });
